...
1. **🔀 Clone the Repository:**
   ```bash
   git clone https://github.com/PUndead/Analyzing-Income-Statement-BalanceSheet-Table-with-OpenAI.git
   ```
...
For any inquiries or feedback, please reach out to [SHRIPAD DHAS](shripaddhas735@gmail.com).
